...
const getCurrentCalendar = async (): Promise<string> => {
    const dataCalendarApi = await fetch('https://hook.eu2.make.com/vldonjya4q4p85mt78criinqs62ci4um')
...
const appToCalendar = async (text: string) => {
    try {
        ...
        console.log(payload)
        const dataApi = await fetch('https://hook.eu2.make.com/wk0bd6li5idupa3o65vtulcqgk4b29vu', {
            method: 'POST',
            headers: {
